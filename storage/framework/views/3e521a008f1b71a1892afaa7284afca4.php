...
<div style="display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 1.25rem;">
    ...
    <a href="<?php echo e(route('master.polis.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.api-settings.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.staff.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.doctors.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.action-masters.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.drugs.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.schedules.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.rooms.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('master.permissions.index')); ?>" class="master-card">
    ...
    <a href="<?php echo e(route('admin.failed-jobs.index')); ?>" class="master-card">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/master/dashboard.blade.php ENDPATH**/ ?>