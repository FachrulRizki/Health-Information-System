...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', config('app.name')); ?> — RME</title>
...
<body class="min-h-screen flex">
    ...
    <aside id="sidebar" class="flex flex-col min-h-screen relative">
        ...
        <div class="px-4 py-5 flex items-center gap-3" style="border-bottom: 1px solid rgba(212,160,23,0.25);">
            ...
            <div class="min-w-0">
                <h1 class="text-sm font-bold text-white leading-tight truncate"><?php echo e(config('app.name')); ?></h1>
        ...
        <nav class="flex-1 overflow-y-auto py-2 px-2 space-y-0.5">
            ...
            <?php if(in_array('*', $userPermissions) || in_array('registration', $userPermissions)): ?>
            <a href="<?php echo e(route('registration.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('registration.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-user-plus nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Pendaftaran</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('admisi', $userPermissions)): ?>
            <a href="<?php echo e(route('admisi.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('admisi.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-bed-pulse nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Admisi</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('queue', $userPermissions)): ?>
            <a href="<?php echo e(route('queue.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('queue.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-list-ol nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Antrian</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('rme', $userPermissions)): ?>
            <a href="<?php echo e(route('rme.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('rme.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-stethoscope nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Rawat Jalan</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('inpatient', $userPermissions)): ?>
            <a href="<?php echo e(route('inpatient.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('inpatient.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-hospital-user nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Rawat Inap</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('lab', $userPermissions)): ?>
            <a href="<?php echo e(route('lab.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('lab.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-flask nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Laboratorium</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('radiology', $userPermissions)): ?>
            <a href="<?php echo e(route('radiology.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('radiology.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-x-ray nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Radiologi</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('pharmacy', $userPermissions)): ?>
            <a href="<?php echo e(route('pharmacy.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('pharmacy.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-pills nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Farmasi</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('billing', $userPermissions)): ?>
            <a href="<?php echo e(route('billing.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('billing.*') && !request()->routeIs('claims.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-file-invoice-dollar nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Billing</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('claims', $userPermissions)): ?>
            <a href="<?php echo e(route('berkas-digital.index')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('berkas-digital.*') || request()->routeIs('claims.*') ? 'active' : ''); ?>">
            ...
            <?php if(in_array('*', $userPermissions) || in_array('report', $userPermissions) || in_array('master.data', $userPermissions)): ?>
            <p class="sidebar-section-label">Manajemen</p>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('report', $userPermissions)): ?>
            <a href="<?php echo e(route('report.visits')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('report.*') ? 'active' : ''); ?>">
                <i class="fa-solid fa-chart-bar nav-icon w-4 text-center flex-shrink-0"></i>
                <span class="nav-label">Laporan</span>
            </a>
            <?php endif; ?>

            <?php if(in_array('*', $userPermissions) || in_array('master.data', $userPermissions)): ?>
            <a href="<?php echo e(route('master.dashboard')); ?>"
               class="sidebar-link <?php echo e(request()->routeIs('master.*') ? 'active' : ''); ?>">
        ...
        <div class="px-3 py-3" style="border-top: 1px solid rgba(212,160,23,0.3);">
            <div class="user-info flex items-center gap-2.5 mb-2.5">
                <div class="w-9 h-9 rounded-full flex items-center justify-center font-bold text-sm flex-shrink-0"
                    ...
                    <?php echo e(strtoupper(substr(auth()->user()->username ?? 'U', 0, 2))); ?>

                </div>
                <div class="min-w-0">
                    <p class="text-xs font-semibold text-white truncate"><?php echo e(auth()->user()->username); ?></p>
                    <p class="text-xs capitalize" style="color: rgba(212,160,23,0.85);"><?php echo e(str_replace('_', ' ', auth()->user()->role)); ?></p>
                </div>
            </div>
            ...
            <div class="flex items-center gap-2 flex-shrink-0">
                ...
                <div class="flex items-center gap-2 pl-2" style="border-left: 1px solid #E8D5D5;">
                    ...
                    <div class="hidden sm:block">
                        <p class="text-xs font-semibold leading-tight" style="color: #1A0A0A;"><?php echo e(auth()->user()->username); ?></p>
                        <p class="text-xs capitalize" style="color: #6B4C4C;"><?php echo e(str_replace('_', ' ', auth()->user()->role)); ?></p>
                    </div>
                </div>
    ...
    (function () {
        ...
        if (typeof window.Echo !== 'undefined') {
            var userId = <?php echo e(auth()->id() ?? 'null'); ?>;
            if (userId) {
...
<?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/layouts/app.blade.php ENDPATH**/ ?>