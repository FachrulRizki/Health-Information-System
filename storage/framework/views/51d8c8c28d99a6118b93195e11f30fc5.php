...
<div class="flex items-center justify-between mb-5">
    ...
    <div class="flex items-center gap-2 text-xs flex-wrap">
        ...
        <span class="px-2.5 py-1 rounded-full font-medium border"
              style="background: <?php echo e($leg['bg']); ?>; color: <?php echo e($leg['color']); ?>; border-color: <?php echo e($leg['border']); ?>;">
...
<div class="bg-white rounded-xl p-4 mb-5" style="border:1px solid #E8D5D5; box-shadow:0 2px 8px rgba(123,29,29,0.06);">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <a href="<?php echo e(route('rme.index')); ?>" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border" style="color:#6B4C4C; border-color:#E8D5D5;">
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="transition-colors"
                    style="background: <?php echo e($rowBg); ?>; border-bottom: 1px solid <?php echo e($rowBorder); ?>20;">
                    ...
                    <td class="px-5 py-3.5">
                        <span class="px-2.5 py-1 rounded-full text-xs font-semibold border"
                              style="background: <?php echo e($statusBg); ?>; color: <?php echo e($statusColor); ?>; border-color: <?php echo e($rowBorder); ?>40;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/rme/index.blade.php ENDPATH**/ ?>