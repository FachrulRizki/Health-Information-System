...
<form method="GET" action="<?php echo e(route('inpatient.index')); ?>"
    ...
    <div class="flex-1 min-w-[160px]">
        ...
        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Nama / No. RM..."
               class="w-full border rounded-xl px-3 py-2 text-sm focus:outline-none focus:ring-2"
               style="border-color: #E8D5D5; --tw-ring-color: rgba(123,29,29,0.15);">
    </div>
    <div class="flex gap-2">
        ...
        <?php if(request()->hasAny(['date_from','date_to','search'])): ?>
...
<div class="flex items-center justify-between mb-4 flex-wrap gap-3">
    ...
    <a href="<?php echo e(route('inpatient.beds')); ?>"
...
<div class="bg-white rounded-2xl overflow-hidden" style="border: 1px solid #E8D5D5; box-shadow: 0 2px 8px rgba(123,29,29,0.06);">
    <div class="px-5 py-3.5 flex items-center justify-between" style="background: #F9F5F5; border-bottom: 1px solid #E8D5D5;">
        ...
        <span class="text-xs px-2.5 py-1 rounded-full font-semibold"
            ...
            <?php echo e($records->count()); ?> pasien
        </span>
    </div>
                    ...
                    <tr class="hover:bg-red-50 transition-colors">
                        ...
                        <td class="px-5 py-3.5">
                            <?php if($record->bed): ?>
                                <div class="flex items-center gap-1.5">
                                    ...
                                    <span class="text-sm" style="color: #1A0A0A;"><?php echo e($record->bed?->room?->nama_kamar ?? '—'); ?></span>
                                    <span class="text-xs font-mono px-1.5 py-0.5 rounded"
                                          style="background: #FFF5F5; color: #7B1D1D; border: 1px solid #E8D5D5;">
                                        <?php echo e($record->bed->kode_bed); ?>
                        ...
                        <td class="px-5 py-3.5">
                            ...
                            <span class="px-2.5 py-1 rounded-full text-xs font-semibold" style="<?php echo e($statusStyle); ?>">
                                <?php echo e(ucfirst(str_replace('_', ' ', $record->status_pulang ?? 'Aktif'))); ?>

                            </span>
                        </td>
                        <td class="px-5 py-3.5">
                            <a href="<?php echo e(route('inpatient.show', $visit?->id)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/inpatient/index.blade.php ENDPATH**/ ?>