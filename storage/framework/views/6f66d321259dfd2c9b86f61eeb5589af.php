...
<div>
    ...
    <input type="text" name="nama" value="<?php echo e(old('nama', $record?->nama)); ?>" class="w-full border border-gray-300 rounded px-3 py-2 text-sm" required>
</div>
<div>
    ...
    <select name="drug_category_id" class="w-full border border-gray-300 rounded px-3 py-2 text-sm" required>
        ...
        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($cat->id); ?>" <?php echo e(old('drug_category_id', $record?->drug_category_id) == $cat->id ? 'selected' : ''); ?>><?php echo e($cat->nama); ?></option>
...
<div>
    ...
    <select name="drug_unit_id" class="w-full border border-gray-300 rounded px-3 py-2 text-sm" required>
        ...
        <?php $__currentLoopData = $units; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $unit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($unit->id); ?>" <?php echo e(old('drug_unit_id', $record?->drug_unit_id) == $unit->id ? 'selected' : ''); ?>><?php echo e($unit->nama); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
</div>
<div>
    ...
    <select name="supplier_id" class="w-full border border-gray-300 rounded px-3 py-2 text-sm">
        ...
        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sup): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($sup->id); ?>" <?php echo e(old('supplier_id', $record?->supplier_id) == $sup->id ? 'selected' : ''); ?>><?php echo e($sup->nama); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </select>
</div>
<div>
    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Beli <span class="text-red-500">*</span></label>
    <input type="number" name="harga_beli" value="<?php echo e(old('harga_beli', $record?->harga_beli ?? 0)); ?>" class="w-full border border-gray-300 rounded px-3 py-2 text-sm" min="0" step="0.01" required>
</div>
<div>
    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Jual <span class="text-red-500">*</span></label>
    <input type="number" name="harga_jual" value="<?php echo e(old('harga_jual', $record?->harga_jual ?? 0)); ?>" class="w-full border border-gray-300 rounded px-3 py-2 text-sm" min="0" step="0.01" required>
</div>
...
<?php $existingStock = $record?->stocks?->first(); ?>
<div style="border-top:1px solid #E8D5D5; padding-top:1rem; margin-top:1rem;">
    <h4 class="text-sm font-semibold mb-3" style="color:#7B1D1D;">
        ...
        <?php echo e($record ? 'Update Stok' : 'Stok Awal'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="number" name="initial_stock"
                   value="<?php echo e(old('initial_stock', $existingStock?->quantity ?? '')); ?>"
        ...
        <div>
            ...
            <input type="number" name="minimum_stock"
                   value="<?php echo e(old('minimum_stock', $existingStock?->minimum_stock ?? 10)); ?>"
                   min="0" step="0.01" required
                   class="w-full border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2"
                   style="border-color:#E8D5D5; --tw-ring-color:rgba(123,29,29,0.15);">
        </div>
        <div>
            ...
            <input type="date" name="expiry_date"
                   value="<?php echo e(old('expiry_date', $existingStock?->expiry_date?->format('Y-m-d') ?? '')); ?>"
                   required
                   class="w-full border rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:ring-2"
                   style="border-color:#E8D5D5; --tw-ring-color:rgba(123,29,29,0.15);">
        </div>
        <div>
            ...
            <input type="text" name="batch_number"
                   value="<?php echo e(old('batch_number', $existingStock?->batch_number ?? '')); ?>"
...
<?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/master/fields/drugs.blade.php ENDPATH**/ ?>