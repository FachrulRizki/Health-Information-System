...
<body class="min-h-screen flex" style="background: #F9F5F5;">
    ...
    <div class="hidden lg:flex lg:w-3/5 login-left flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div class="relative z-10 text-center max-w-md">
            ...
            <h1 class="text-4xl font-bold text-white mb-3 leading-tight"><?php echo e(config('app.name')); ?></h1>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div class="rounded-xl p-3 text-center" style="background: rgba(255,255,255,0.08);">
                    <i class="fa-solid <?php echo e($icon); ?> text-xl mb-1.5 block" style="color: rgba(212,160,23,0.9);"></i>
                    <p class="text-xs" style="color: rgba(255,255,255,0.7);"><?php echo e($label); ?></p>
                </div>
    ...
    <div class="w-full lg:w-2/5 flex items-center justify-center p-6 sm:p-10" style="background: #fff;">
        <div class="w-full max-w-sm fade-in-right">
            ...
            <div class="lg:hidden text-center mb-8">
                ...
                <h1 class="text-xl font-bold" style="color: #1A0A0A;"><?php echo e(config('app.name')); ?></h1>
...
$message = $__bag->first($__errorArgs[0]); ?> <?php else: ?> <?php unset($message);
...
<?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/auth/login.blade.php ENDPATH**/ ?>