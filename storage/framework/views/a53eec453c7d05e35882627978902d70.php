...
<head>
    ...
    <title>Display Antrian — <?php echo e($poli->nama_poli); ?></title>
...
<body class="bg-gray-900 text-white min-h-screen flex flex-col">
    <header class="bg-gray-800 px-8 py-4 flex justify-between items-center border-b border-gray-700">
        <div>
            ...
            <h1 class="text-2xl font-bold"><?php echo e($poli->nama_poli); ?></h1>
        </div>
    ...
    <main class="flex-1 flex flex-col items-center justify-center px-8 py-10 gap-10">
        <div class="w-full max-w-2xl">
            ...
            <div id="current-card" class="rounded-2xl p-10 text-center <?php echo e($current ? 'calling' : 'bg-gray-800'); ?> transition-all">
                <p class="text-8xl font-black tracking-tight" id="current-number"><?php echo e($current?->queue_number ?? '—'); ?></p>
                <p class="text-3xl font-semibold mt-4 text-blue-100" id="current-name">
                    <?php echo e($current?->visit?->patient?->nama_lengkap ?? 'Belum ada pasien dipanggil'); ?>
        ...
        <div class="w-full max-w-2xl">
            ...
            <div id="waiting-list" class="grid grid-cols-5 gap-3">
                <?php $__empty_1 = true; $__currentLoopData = $waiting; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="bg-gray-800 rounded-xl p-4 text-center border border-gray-700">
                        <p class="text-3xl font-bold text-yellow-400"><?php echo e($entry->queue_number); ?></p>
                        <p class="text-xs text-gray-400 mt-1 truncate"><?php echo e($entry->visit?->patient?->nama_lengkap ?? '-'); ?></p>
                    </div>
    ...
    <footer class="bg-gray-800 px-8 py-3 text-center text-gray-500 text-xs border-t border-gray-700">
        <?php echo e(config('app.name')); ?> — Display Antrian Real-time
    </footer>

<script>
const POLI_ID = <?php echo e($poliId); ?>;
...
<?php /**PATH /Applications/MAMP/htdocs/kiro/nesthis/resources/views/queue/display.blade.php ENDPATH**/ ?>