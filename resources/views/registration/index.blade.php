...
<div class="bg-white rounded-xl p-4 mb-5" style="border: 1px solid #E8D5D5; box-shadow: 0 2px 8px rgba(123,29,29,0.06);">
    <form method="GET" class="flex flex-wrap gap-3 items-end">
        ...
        <a href="{{ route('registration.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium border" style="color:#6B4C4C; border-color:#E8D5D5;">
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y" style="border-color: #E8D5D5;">
                ...
                <tr class="hover:bg-red-50 transition-colors" style="border-bottom: 1px solid #F0E8E8;">
                    <td class="px-5 py-3.5 font-mono text-xs" style="color: #6B4C4C;">{{ $patient->no_rm }}</td>
                    ...
                    <td class="px-5 py-3.5">
                        <div class="flex gap-2">
                            <a href="{{ route('registration.show', $patient->id) }}"
                ...
                <tr>
                    <td colspan="5" class="px-5 py-12 text-center">
                        ...
                        <p class="text-sm font-medium" style="color: #6B4C4C;">Tidak ada pasien ditemukan untuk "{{ $q }}"</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
        ...
        <table class="w-full text-sm">
            ...
            <tbody class="divide-y" style="border-color: #E8D5D5;">
                ...
                <tr class="hover:bg-red-50 transition-colors" style="border-bottom: 1px solid #F0E8E8;">
                    ...
                    <td class="px-5 py-3.5 font-mono text-xs" style="color: #6B4C4C;">{{ $visit->patient?->no_rm ?? '-' }}</td>
                    <td class="px-5 py-3.5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0"
                                 style="background: linear-gradient(135deg, #7B1D1D, #9B2C2C);">
                    ...
                    <td class="px-5 py-3.5">
                        <a href="{{ route('registration.show', $visit->patient_id) }}"
                           class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-white transition-all hover:opacity-90"
                           style="background: #7B1D1D;">
                            <i class="fa-solid fa-eye"></i> Cek Detail
                        </a>
