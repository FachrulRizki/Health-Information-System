...
<div class="bg-white rounded-2xl p-12 text-center" style="border: 1px solid #E8D5D5; box-shadow: 0 2px 8px rgba(123,29,29,0.06);">
    ...
    <p class="text-sm font-medium" style="color: #6B4C4C;">Tidak ada pasien ditemukan untuk "<strong>{{ $q }}</strong>"</p>
</div>
                ...
                <tr class="hover:bg-red-50 transition-colors">
                    <td class="px-5 py-3.5">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <p class="font-semibold" style="color: #1A0A0A;">{{ $patient->nama_lengkap }}</p>
                                @if($patient->no_bpjs)
                                <p class="text-xs font-mono" style="color: #6B4C4C;">BPJS: {{ $patient->no_bpjs }}</p>
                                @endif
                            </div>
                        </div>
                    </td>
